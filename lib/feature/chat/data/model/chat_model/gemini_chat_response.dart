...
class GeminiChatResponse {
  ...
  GeminiChatResponse(
      ...
      this.modelVersion,
      this.responseId});
factory GeminiChatResponse.fromJson(Map<String, dynamic> json) => _$GeminiChatResponseFromJson(json);
  Map<String, dynamic> toJson() => _$GeminiChatResponseToJson(this);
}
@JsonSerializable()
class Candidates {
  Content? content;
